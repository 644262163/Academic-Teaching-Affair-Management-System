  ...
  table.on('tool(demo)', function(obj){
    ...
    if(obj.event === 'detail'){
      ...
      layer.open({
        ...
        area: ['840px', '420px'], //宽高
        content: '\
          <form class="layui-form layui-form-pane" action="<%=request.getContextPath() %>/admin/update_teacher.do">\
  ...
  var $ = layui.$, active = {
    insertTeacher: function(){ //添加老师
      layer.open({
        ...
        area: ['840px', '420px'], //宽高
        content: '\
          <form class="layui-form layui-form-pane" action="<%=request.getContextPath() %>/admin/insert_teacher.do">\
            <div class="layui-form-item">\
              <label class="layui-form-label">用户名</label>\
              <div class="layui-input-block">\
