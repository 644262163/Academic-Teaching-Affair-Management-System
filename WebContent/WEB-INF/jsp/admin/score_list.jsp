  ...
  table.on('tool(demo)', function(obj){
    ...
    if(obj.event === 'detail'){
      ...
      layer.open({
        ...
        area: ['840px', '420px'], //宽高
        content: '\
          <form class="layui-form layui-form-pane" action="<%=request.getContextPath() %>/admin/update_score.do">\
  ...
  var $ = layui.$, active = {
    insertScore: function(){ //添加分数
      layer.open({
        ...
        area: ['840px', '420px'], //宽高
        content: '\
          <form class="layui-form layui-form-pane" action="<%=request.getContextPath() %>/admin/insert_score.do">\
          <div class="layui-form-item">\
            <label class="layui-form-label">学生id</label>\
              <div class="layui-input-block">\
